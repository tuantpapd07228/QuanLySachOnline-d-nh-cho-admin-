...
public class ThongKeDoanhThuTheoKhoangThoiGianFragment extends Fragment {
    ReadData readData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_thong_ke_doanh_thu_theo_khoang_thoi_gian, container, false);
